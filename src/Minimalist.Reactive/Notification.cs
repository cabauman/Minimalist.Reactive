...
public abstract class Notification<T> : IEquatable<Notification<T>>
{
    ...
    internal sealed class OnCompletedNotification : Notification<T>
    {
        ...
        /// </summary>
        public override T Value { get { throw new InvalidOperationException("OnCompleted notification doesn't have a value."); } }
    ...
    private sealed class NotificationToObservable : IObservable<T>
    {
